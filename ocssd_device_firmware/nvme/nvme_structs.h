...
typedef enum _NVME_ADMIN_OPCODE_E
{
	...
	OC_ADMIN_OPCODE_GET_LOG_PAGE					= NVME_ADMIN_OPCODE_GET_LOG_PAGE,
	...
	OC_ADMIN_OPCODE_SET_FEATURE						= NVME_ADMIN_OPCODE_SET_FEATURE,
	NVME_ADMIN_OPCODE_GET_FEATURE					= 0x0A,
	OC_ADMIN_OPCODE_GET_FEATURE						= NVME_ADMIN_OPCODE_GET_FEATURE,
	...
	OC_ADMIN_OPECODE_GEOMETRY						= 0xE2,
} NVME_ADMIN_OPCODE_E;
...
#define IO_NVM_PPA_VECTOR_CHUNK_RESET			0x90
...
typedef enum _NVME_NVM_OPCODE_E
{
	...
	OC_NVM_PPA_OPCODE_WRITE							= NVME_NVM_OPCODE_WRITE,
	NVME_NVM_OPCODE_READ							= 0x02,
	OC_NVM_PPA_OPCODE_READ							= NVME_NVM_OPCODE_READ,
	...
	OC_NVM_PPA_OPCODE_DATASET_MANAGEMENT			= NVME_NVM_OPCODE_DATASET_MANAGEMENT,
	...
	OC_NVM_PPA_OPCODE_VECTOR_CHUNK_READ				= 0x92, //optional
	OC_NVM_PPA_OPCODE_VECTOR_CHUNK_COPY				= 0x93, //optional
...
typedef enum _NVME_FEATURE_ID_E
{
	...
	OC_FEATURE_ID_ERROR_RECOVERY					= NVME_FEATURE_ID_ERROR_RECOVERY,
	...
	OC_FEATURE_ID_MEDIA_FEEDBACK					= 0xCA,
} NVME_FEATURE_ID_E;
